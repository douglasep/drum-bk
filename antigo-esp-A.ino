      ...
      #define LED_PIN_8 17
      #define LED_PIN_9 5
      #define LED_PIN_10 15 // descarte
      
      // -----------------------------------------------------------------------------
      // Pinos utilizados como Entrada dos piezos dos Pads
      // -----------------------------------------------------------------------------

      #define PIEZO_PIN_1 26 // ok
      #define PIEZO_PIN_2 31 // ok
      #define PIEZO_PIN_3 35 // ok
      #define PIEZO_PIN_4 31 // ok
      #define PIEZO_PIN_5 31 // ok
      #define PIEZO_PIN_6 31 // ok
      #define PIEZO_PIN_7 25 // ok
      #define PIEZO_PIN_8 33 // ok (vn)
      #define PIEZO_PIN_9 32 // ok mas com disturbios
      #define PIEZO_PIN_10 31 // descarte 
    ...
    // -----------------------------------------------------------------------------
      ...
      void loop()
      {
        ...
        int16_t safetyRange = 50;
        Serial.println("switcherMode1: " + String(switcherMode1));
        Serial.println("switcherMode2: " + String(switcherMode2));
