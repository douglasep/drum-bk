...
// -----------------------------------------------------------------------------
#define KEYPAD_PIN_1 18
#define KEYPAD_PIN_2 19
#define KEYPAD_PIN_3 20
...
//struct Led_Pad_Type ledPadType1 = { PAD_TYPE_1, 45, 6, 220, colorPr, colorSc };
//struct Led_Pad_Type ledPadType2 = { PAD_TYPE_2, 45, 6, 220, colorPr, colorSc };
//struct Led_Pad_Type ledPadType3 = { PAD_TYPE_3, 45, 6, 220, colorPr, colorSc };
...
const uint16_t triggerThresholds[NUM_PADS] = {400, 400, 400, 400, 400, 400, 400, 400, 400}; // Threshold iniciais {pad1, pad2, pad3, pad2}
...
void loop() { 
  // Leds Loop
  // if(analogRead(PIEZO_PIN_1) > 100) {
  //   Serial.println("Entrada padNo 1: " + String(analogRead(PIEZO_PIN_1)));  
  // }
  // if(analogRead(PIEZO_PIN_2) > 100) {
  //   Serial.println("Entrada padNo 2: " + String(analogRead(PIEZO_PIN_2)));  
  // }
  // if(analogRead(PIEZO_PIN_3) > 100) {
  //   Serial.println("Entrada padNo 3: " + String(analogRead(PIEZO_PIN_3)));  
  // }
